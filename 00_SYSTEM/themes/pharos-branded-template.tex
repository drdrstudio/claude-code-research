...
% Brand colors (using professional navy and gray)
\definecolor{PharosBlue}{HTML}{1B365D}
\definecolor{PharosGray}{HTML}{4A4A4A}

% Section styling
\allsectionsfont{\bfseries\color{PharosBlue}}

% Headers and footers
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\includegraphics[height=0.4in]{$logo_file$}}
\fancyhead[R]{\textcolor{PharosGray}{\small\textbf{Strategic Analysis}}}
\fancyfoot[C]{\textcolor{PharosGray}{\thepage}}
...
\hypersetup{
    colorlinks=true,
    urlcolor=PharosBlue,
    linkcolor=PharosBlue,
    filecolor=PharosBlue,
    citecolor=PharosBlue
}
