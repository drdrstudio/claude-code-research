    ...
    case $RECIPE_CHOICE in
        1)  # Reputational Intelligence
            ...
            if [ -f "${SYSTEM_DIR}/reputational-scan-dispatcher.sh" ]; then
                "${SYSTEM_DIR}/reputational-scan-dispatcher.sh" "$PROJECT_PATH" "$TARGET_NAME"
        ...
        2)  # Organizational Intelligence
            ...
            if [ -f "${SYSTEM_DIR}/organizational-scan-dispatcher.sh" ]; then
                "${SYSTEM_DIR}/organizational-scan-dispatcher.sh" "$PROJECT_PATH" "$TARGET_NAME"
        ...
        3)  # GTM Marketing Research
            ...
            if [ -f "${SYSTEM_DIR}/gtm-marketing-dispatcher.sh" ]; then
                "${SYSTEM_DIR}/gtm-marketing-dispatcher.sh" "$PROJECT_PATH" "$TARGET_NAME" "$TARGET_MARKET"
